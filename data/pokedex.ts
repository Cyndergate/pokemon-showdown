export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	shuckle: {
		...
		color: "Yellow",
		eggGroups: ["Bug"],
		otherFormes: ["Shuckle-Mega-Defense", "Shuckle-Mega-Offence"],
		formeOrder: ["Shuckle", "Scizor-Mega-Defense", "Shuckle-Mega-Offence"],
	},
	heracross: {
		num: 214,
		name: "Heracross",
	...
	shucklemegadef: {
		num: 213,
		name: "Shuckle-Mega-Defense",
		baseSpecies: "Shuckle",
		forme: "Mega",
		types: ["Bug", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 20, atk: 10, def: 300, spa: 10, spd: 300, spe: 10},
		abilities: {0: "Thick Fat"},
		heightm: 2.4,
		weightkg: 155.5,
		color: "Yellow",
		eggGroups: ["Monster", "Grass"],
		requiredItem: "Shucklite Def",
	},
	shucklemegaoff: {
		num: 213,
		name: "Shuckle-Mega-Offence",
		baseSpecies: "Shuckle",
		forme: "Mega",
		types: ["Bug", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 20, atk: 300, def: 10, spa: 300, spd: 10, spe: 10},
		abilities: {0: "Contrary"},
		heightm: 2.4,
		weightkg: 155.5,
		color: "Yellow",
		eggGroups: ["Monster", "Grass"],
		requiredItem: "Shucklite Off",
	},
	zenith: {
		num: 2001,
		name: "Zenith",
